...
- golden ("Golden Trellis Cushion Cover") was added July 2026 as the 5th design — marigold-gold medallions on a trailing vine with blue accents, green border. Photos: images/products/golden/1.jpg .. 11.jpg, converted from the user's "Ghar Cushions Photo/New 1..11.jpeg" folder on Desktop.
...
- shop.html has a small (64×64px, `.shop-hero-img`) lifestyle photo (images/site/shop-hero.jpg, from "Main photo.png" in the same Desktop folder) next to the "Cushion covers. First of many." heading — keep it small; do not let it grow to a full hero banner.
